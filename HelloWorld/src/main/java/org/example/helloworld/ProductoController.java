...
public class ProductoController {
    ...
    public ResponseEntity<Producto> actualizarParcialmenteProducto(@PathVariable Long productoId, @RequestBody Producto datosParciales) {
    ...
    public ResponseEntity<Producto> listarProductoPorId(@PathVariable Long productoId) {
    ...
    public ResponseEntity<Producto> comprarProducto(@PathVariable Long productoId) {
    ...
    public ResponseEntity<Producto> reponerStock(@PathVariable Long productoId, @RequestParam int cantidad) {
